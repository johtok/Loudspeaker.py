...
def _render_suite(name: str, result, forcing_values) -> None:
    ...
    save_figure(phase_ax, OUT_DIR / f"{slug}_phase_raw.png")
    ...
    save_figure(phase_norm_ax, OUT_DIR / f"{slug}_phase_normalized.png")
    ...
    save_figure(ts_ax, OUT_DIR / f"{slug}_timeseries_raw.png")
    ...
    save_figure(ts_norm_ax, OUT_DIR / f"{slug}_timeseries_normalized.png")
    ...
    if result.coil_force is not None:
        ...
        save_figure(mech_ax, OUT_DIR / f"{slug}_coil_force_vs_voltage.png")
