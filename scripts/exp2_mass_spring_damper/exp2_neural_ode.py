...
def run_exp2():
    ...
    with timeout_context(600):  # 10 minute timeout
        ...
        plot_trajectories(trained_model, test_data, config, num_samples=min(3, len(test_data['initial_conditions'])))
        plot_phase_space(trained_model, test_data, config, num_samples=min(2, len(test_data['initial_conditions'])))
